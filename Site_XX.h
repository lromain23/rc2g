...
#define AUXOUTARG1 AUX_OUT_FOLLOW_PTT4 | AUX_OUT_FOLLOW_PTT_DELAY | AUX_OUT_FOLLOW_PTT_INVERT_OUTPUT

// Fan Repeteur
#define AUXOUTOP2 AUX_OUT_FOLLOW_PTT
#define AUXOUTARG2 AUX_OUT_FOLLOW_PTT3 | AUX_OUT_FOLLOW_PTT2 | AUX_OUT_FOLLOW_PTT1 | AUX_OUT_FOLLOW_PTT_DELAY | AUX_OUT_FOLLOW_PTT_INVERT_OUTPUT
